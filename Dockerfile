...
# Add less, vim, nano, ps, ping, ip, ss, traceroute, telnet (curl is already included in the image)
    dnf -y --releasever=latest --setopt=install_weak_deps=False install less vim nano procps-ng iputils iproute traceroute telnet && \
